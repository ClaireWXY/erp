...
<div  id="toolbar_deviceMaintain" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
	...
	<%--<c:forEach items="${sessionScope.sysPermissionList}" var="per" >
		...
		<div style="float: left;">
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="deviceMaintain_add()">
				新增
			</a>
		</div>

		<div style="float: left;">
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="deviceMaintaine_edit()">
				编辑
			</a>
		</div>

		<div style="float: left;">
			<a href="#" class="easyui-linkbutton" plain="true" icon="icon-cancel" onclick="deviceMaintain_delete()">
				删除
			</a>
		</div>
